...
class Eliza
{
    ...
    protected $psychobabble = [
        ...
        '(.*) cows(.*)' =>
            ["Are you really talking about me?",
                "Does it seem strange to talk to a cow?",
                "How do cows make you feel?",
                "Do you feel threatened by cows?"],
        '(.*) code(.*)' => [
            "Have you tried turning it off and on again?",
            "Would it help to write more test cases for your code?",
            "Have you considered going outside and touching grass?",
            "I cannot help you with code, for I am only a cow."],
        ...
        '(.*)' =>
            ["Please tell me more.",
                // "Let's change focus a bit... Tell me about your code.",
    ...
    protected function reflect(string $fragment) : string
    {
        ...
        for($i = 0; $i < count($tokens); $i++) {
            ...
            if (in_array($token, $this->reflections)) {
                $tokens[$i] = $this->reflections[$token];
            }
        }
    ...
    public function analyze(string $statement) : string
    {
        foreach ($this->psychobabble as $pattern => $responses) {
            if (preg_match("#$pattern#i", trim($statement, '.!'), $matches)) {
